...
/**
 * Class generate company data.
 *
 * @package PHPFaker
 * @subpackage Generator
 */
class CompanyGenerator extends AbstractGenerator
{
    ...
    public function name()
    {
        foreach ($this->random(self::$_name_formats) as $elem) {
            ...
            if ($elem == 'surname') {
                $result[count($result) - 1] = $this->getGenerator('name')->surname();
            }
        }
        return join($result);
    }
